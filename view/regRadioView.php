				...
				<div class="container-fluid">
					...
					<div class="row">
						...
						<div class="col-lg-12 mb-4">
							<h4>Registrar radio Portatil</h4>
							<div class="container">
										...
										<form action="" method="post" class="user" role="form" id="userForm">
											<div class="row">
												<div class="col-lg-6">
													<div class="text-center">
														...
														<div class="p-5">
															...
															<div class="form-group row">
																<div class="col-sm-6 mb-3 mb-sm-0">
																	<input type="text" name="serial_bateria" id="serial_bateria" class="form-control " placeholder="Serial de la bateria" autocomplete="off" maxlength="22" required="required" value="<?php echo isset($_POST['serial_bateria']) ? $_POST['serial_bateria']:""; ?>" onKeyUp="mayusculas(this);">
																</div>
																<div class="col-sm-6 mb-3 mb-sm-0">
															...
															<div class="form-group row">
																<div class="col-sm-6">
																	<select name="tipo_comunicacion" class="form-control  p-1" required="required">
																		<option value="">Tipo de radio...</option>
																		<option value="PORTATIL">Portatil</option>
																		<option value="PORTATIL CON PANTALLA">Portatil con pantalla</option>
																		<option value="ESTACION FIJA">Estacíon Fija</option>
												...
												<div class="form-group" style="margin-left: 40%;">
													<div class="text-center">
														<div class="col-sm-5">
															<button type="submit" name="submit" value="regRadio" id="btnRegRadio" class="btn btn-primary btn-user btn-block">Registrar</button>
